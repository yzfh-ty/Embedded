  ...
  return (
    <button class={classNames(displayClass, "readermode")}>
      ...
      >
        <title>{i18n(cfg.locale).components.readerMode.title}</title>
        <g transform="translate(-1.8, -1.8) scale(1.15, 1.2)">
          <path d="M3 3L21 21M8.99 2.5C10.14 2.5 11.22 2.97 12 3.77C12.78 2.97 13.87 2.5 15.02 2.5L18.75 2.5C19.17 2.5 19.5 2.84 19.5 3.25L19.5 4H21.25C21.66 4 22 4.34 22 4.75V20.25C22 20.66 21.66 21 21.25 21H8.75M6 18.5H5.25C4.87 18.5 4.56 18.22 4.51 17.85L4.5 17.75V5.5H3.5V19.5H6M12 5.21V8M12.75 10.75V17.78C13.49 17.27 14.34 17 15.24 17H18V17.75C18 18.16 17.66 18.5 17.25 18.5H15.24" stroke="currentColor" stroke-width="1.5" fill="none"/>
        </g>
      </svg>
    </button>
  )
